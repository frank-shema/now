                        ...
                        <div>
                                {folder?.images?.length === 0 ? (
                                        <div className="w-full h-[300px] flex items-center justify-center">
                                                <p className="text-gray-700 text-2xl">No Images So far</p>
                                        </div>
                                ) : (
                ...
                return (
                        <div >
                                {folder?.videos?.length === 0 ? (
                                        <div className="w-full h-[300px] flex items-center justify-center">
                                                <p className="text-gray-700 text-2xl">No Videos So far</p>
                                        </div>
                                ) : (
                                        <div className='grid grid-cols-3 gap-5 p-5'>
                ...
                return (
                        <div>
                                {folder?.documents?.length === 0 ? (
                                        <div className="w-full h-[300px] flex items-center justify-center">
                                                <p className="text-gray-700 text-2xl">No Documents So Far</p>
                                        </div>
                                ) : (
                                        <div className='grid grid-cols-3 gap-5 p-5'>
                                                {folder?.documents?.map((documentUrl, index) => {
                                                        return (
                                                                <a href={documentUrl} key={index} target="_blank" rel="noopener noreferrer">
