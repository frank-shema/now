                                ...
                                <div className="p-3">
                                        {nots.length === 0 ? (
                                                <div className='w-full h-[200px] flex items-center justify-center'>
                                                        <p className="text-2xl text-gray-700">No Notifications so far</p>
                                                </div>
                                        ) : (
                                                <div>
                                                                        ...
                                                                        <div key={date}>
                                                                                ...
                                                                                <div>
                                                                                        {notifications.map((notification) => (
                                                                                                <div key={notification._id} className="relative border-l-2 px-3">
                                                                                                        <div className="absolute w-2 h-2 rounded-full bg-[#555555] top-2 -left-[5px]"></div>
                                                                                                        <p className="font-semibold text-sm my-2"><span className='text-[#005DFFB0]'>{notification.doer.fullName}</span> {notification.action}</p>
                                                                                                        <p className='text-xs'>{notification.createdAt.getHours()}:{notification.createdAt.getMinutes() < 10 ? `0${notification.createdAt.getMinutes()}` : notification.createdAt.getMinutes()}</p>
                                                                                                </div>
                                                                                        ))}
                                                                                </div>
                                                                        </div>
