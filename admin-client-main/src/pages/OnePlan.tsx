        ...
        return (
                <div className='w-full h-full overflow-y-auto overflow-x-hidden p-5'>
                        ...
                        {loading ? (
                                ...
                                <div className="p-3">
                                        <button onClick={() => window.history.back()} className='px-4 py-2 flex gap-2 items-center text-[#555555] my-2'>
                                        ...
                                        <div className="flex gap-2">
                                                <img src={project?.images[0]} alt="" className='w-[60%] rounded-lg' />
                                                <div className="flex gap-3 justify-center w-[40%]">
                                                        <button className="flex gap-2 items-center border-2 rounded-lg h-fit px-4 py-2">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                                                        <path d="M12.8667 5.95016L10.0333 3.15016L10.9667 2.21683C11.2222 1.96127 11.5362 1.8335 11.9087 1.8335C12.2807 1.8335 12.5944 1.96127 12.85 2.21683L13.7833 3.15016C14.0389 3.40572 14.1722 3.71416 14.1833 4.0755C14.1944 4.43638 14.0722 4.74461 13.8167 5.00016L12.8667 5.95016ZM11.9 6.9335L4.83333 14.0002H2V11.1668L9.06667 4.10016L11.9 6.9335Z" fill="#555555" />
                                                                </svg>
                                                                <p>Edit</p>
                                                        </button>
                                                        <button className="flex gap-2 items-center border-2 rounded-lg h-fit px-4 py-2">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                                                        <path d="M5.25 15.75C4.8375 15.75 4.4845 15.6033 4.191 15.3097C3.897 15.0157 3.75 14.6625 3.75 14.25V4.5H3V3H6.75V2.25H11.25V3H15V4.5H14.25V14.25C14.25 14.6625 14.1033 15.0157 13.8097 15.3097C13.5157 15.6033 13.1625 15.75 12.75 15.75H5.25ZM12.75 4.5H5.25V14.25H12.75V4.5ZM6.75 12.75H8.25V6H6.75V12.75ZM9.75 12.75H11.25V6H9.75V12.75ZM5.25 4.5V14.25V4.5Z" fill="#555555" />
                                                                </svg>
                                                                <p>Delete</p>
                                                        </button>
                                                </div>
                                        ...
                                        <div>
                                                ...
                                                <p className='font-semibold my-2 text-[#898989]'>${project?.planPrice}</p>
                                                ...
                                                <div>
                                                        ...
                                                        <div>
                                                                ...
                                                                <button className='text-sm text-[#949494] my-2'>View all Comments</button>
                                                        </div>
                                                </div>
                                                <button className='flex gap-2 text-[#898989] items-center my-2'>
                                                        <p>Advanced Settings</p>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="15" viewBox="0 0 16 15" fill="none" className='rotate-90'>
                                                                <path d="M13.498 9.375L8.49805 4.375L3.49805 9.375" stroke="#555555" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                        </svg>
                                                </button>
                                                <div className="flex gap-2 items-center my-2">
                                                        <p>Turn off commenting</p>
                                                        <Switch onChange={handleCommenting} checked={commenting} uncheckedIcon={false} checkedIcon={false} width={40} height={20} handleDiameter={10} />
                                                </div>
                                        </div>
                                </div>
                        )}
