...
app.get("/notifications/:id", async (req, res) => {
	try {
		...
		const notifications = await Notification.find({ recipients: user.role }).populate("doer");
...
app.use("/project-categories", require("./routes/_projects/project_categories.routes"));
app.use(errHandler);
